...
public class AssetSetter {
	...
	public Objeto objetoUnico() {
		Random rand = new Random();
		    ...
		    case 4: o = new Mochila(30, 3.0, true, 6.0, "Mochila", "Aumenta tu capacidad de inventario en +4 ranuras."); break;
		    case 5: o = new Laptop(50, 10.0, true, 12.5, "Portátil", "Laptop potente que mejora tu visión del mapa."); break;
		    case 6: o = new Celular(50, 8.5, true, 10.0, "Celular", "Emite una señal que aturde a los enemigos cercanos."); break;
		    case 7: o = new Extintor(70, 7.0, true, 8.0, "Extintor", "Apaga incendios y hace 5 puntos de daño a enemigos."); break;
		}
